...
public class FinancialsPVView extends FrameView {
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance().getContext().getResourceMap(FinancialsPVView.class);
        ...
        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance().getContext().getActionMap(FinancialsPVView.class, this);
...
//            tbl_schedule.setValueAt(currency.format(financeObject.getEndingBalance(year)), year - 1, 4);
            ...
            if(financeObject instanceof PresentValue) {
                tbl_schedule.setValueAt(year, year - 1, 0);
                tbl_schedule.setValueAt(currency.format(financeObject.getPrincipleFactor()), year - 1, 1);
